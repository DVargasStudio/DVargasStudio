...
export default function Navigation({menuOpen, SetMenuOpen, inHomePage}) {

  const PressMenu = () => SetMenuOpen(!menuOpen);
  return (
    <div id="Navigation" className={"" + (menuOpen && "Active")}>
        <ul>
            {inHomePage ? <li><a href="/#Home" onClick={PressMenu}><h3>Home</h3></a></li> : <li><Link to="/#Home"><h3 onClick={PressMenu}>Home</h3></Link></li> }
